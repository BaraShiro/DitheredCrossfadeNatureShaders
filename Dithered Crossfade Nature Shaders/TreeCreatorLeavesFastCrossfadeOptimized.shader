...
// Modified shaders copyright (c) 2023 Robert Rosborg. MIT licence (see LICENSE)

Shader "Hidden/Nature/Tree Creator Leaves Fast Crossfade Optimized"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f_leaf VertexLeaf(appdata_full v)
            {
                ...
                fixed ao = v.color.a;
                ao += 0.1;
                ao = saturate(ao * ao * ao); // emphasize AO
